        ...
        while not valid:
            ...
            if self.args.use_fixed_body:
                if (self.args.fixed_bodies is None or len(self.args.fixed_bodies) == 0) and self.args.fixed_body_path is None:
                    ...
                    body = FIXED_BODY(fixed_body=self.args.fixed_bodies, args=self.args)
            ...
            # brain
            # self.args.controller string is the name of the class, we can use eval to get the class
            brain = eval(self.args.controller)(args=self.args)
