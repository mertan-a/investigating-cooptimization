...
from evogym_wrappers import RenderWrapper, ActionSkipWrapper, ActionSpaceCorrectionWrapper, LocalObservationWrapper, GlobalObservationWrapper, LocalActionWrapper, GlobalActionWrapper, RewardShapingWrapper
    ...
    def run(self):
        for b in self.ind.body.bodies:
            ...
            for ts in range(2500):
                action = self.ind.get_action(observation)
